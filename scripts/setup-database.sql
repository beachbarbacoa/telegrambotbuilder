...
-- Run this in your Supabase SQL editor if tables are missing or incomplete
...
-- Create telegram_bots table if it doesn't exist
...
-- Insert a test restaurant to verify everything works
INSERT INTO restaurants (id, name, email, subscription_plan, payment_method, order_limit, orders_used)
VALUES ('00000000-0000-0000-0000-000000000000', 'Test Restaurant', 'test@example.com', 'monthly_50', 'cash_pickup', 50, 0)
